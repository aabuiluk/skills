...
- короткий шлях = `positions.коротко` того ж `theory`; розбір = `positions.детально`
- не `until`, що ховає повний текст; не новий `theory` і не сторінковий extra замість положення
