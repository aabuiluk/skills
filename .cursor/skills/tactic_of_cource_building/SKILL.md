...
description: >-
  ...
  чотири зони chrome / rail / stage / notebook і типи блоків зі схеми скіла.
  Застосовуй, коли треба скелет веб-лекції, блоки пари, tactic_of_cource_building,
  внутрішня структура пари, порожні слоти «Потребує допрацювання».
  Не будує меню курсу — для меню спершу strategy_of_cource_building.
---
...
Не копіюй живу пару й не звіряйся з HTML-прототипом. Схема — ці два файли.

Source deposit: `knowledge_saver/deposits/2026-09-16_tactic-of-cource-building/`.

## Коли

Користувач дає програму (або вже готове меню пар) і просить розкласти **всередину** пари: скелет `presentation.html`, блоки chrome/rail/stage/notebook. Не чекай назви скіла.
...
```json
{
  "pair": { "global_index": 1, "title": "", "duration_min": 80, "sources": [] },
  "zones": {
